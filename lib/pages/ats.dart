        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 20),
              _file != null ? Text('Selected file: ${basename(_file!.path)}') : Text('No file selected.'),
              SizedBox(height: 20),
              ElevatedButton(
                onPressed: () => _uploadFile(_inputPrompt1),
                child: Text('Tell Me About the Resume'),
              ),
              ElevatedButton(
                onPressed: () => _uploadFile(_inputPrompt2),
                child: Text('How can I Improve my Skills'),
              ),
              ElevatedButton(
                onPressed: () => _uploadFile(_inputPrompt3),
                child: Text('What are the Keywords that are Missing'),
              ),
              ElevatedButton(
